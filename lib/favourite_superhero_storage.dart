...
class FavouriteSuperheroStorage {
  static const _key = "favorite_superheroes";

  final updater = PublishSubject<Null>();

  static FavouriteSuperheroStorage? _instance;

  factory FavouriteSuperheroStorage.getInstance() =>
      _instance ??= FavouriteSuperheroStorage._internal();

  FavouriteSuperheroStorage._internal();

  Future<bool> addToFavourites(final Superhero superhero) async {
  ...
  Future<bool> removeFromFavourites(final String id) async {
  ...
  Future<bool> updateInFavorite(final String id, Superhero hero) async {
    final superHeroes = await _getSuperheroes();
    superHeroes[superHeroes.indexWhere((element) => element.id == id)] = hero;
    return _setSuperheroes(superHeroes);
  }
